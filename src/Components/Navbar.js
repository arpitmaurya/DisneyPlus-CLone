...
import { selectUserName, selectUserPhoto, setLoginState, setSignOutState } from '../Redux/Reducer/UserReducer';
                ...
                <Navbrand><NavLink to="#"><img src={disney} alt={disney} /></NavLink></Navbrand>
                {
                    !userName ? (
                        ...
                        <SignOutBtn show={Toggler} onClick={()=> setToggler(false)}>
                            ...
                            <li><NavLink onClick={SignOut} className="nav-link" to="/home"><img src={shutdown} alt={homeIcon} /><span>SignOut</span></NavLink></li>
                        </SignOutBtn>
                    </>
                }
            </Nav>
